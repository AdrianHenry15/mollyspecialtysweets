...
const MainOrderForm = () => {
  ...
  const { setModal, modalError } = useGlobalStore().modalStore;
    ...
    <section className="mt-20 flex-auto flex flex-col items-center">
      <div className="flex flex-col items-center">
        ...
        <div className="form-item">
          ...
          <Select className="form-input" isMulti name="order-options" options={OrderOptions} onChange={(selected: any) => setOrderType(selected)} />
        </div>
        {renderCakeForm()}
        {renderCupcakeForm()}
        {renderCookieForm()}
