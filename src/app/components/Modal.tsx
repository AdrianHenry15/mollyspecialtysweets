...
const Modal = () => {
    ...
    const sendOrder = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        const templateParams = {
            ...
            cakeFruitFilling: `${cakeFruitFilling!.value === "other" ? cakeFruitFillingInput! : cakeFruitFilling!.label}`,
            cakeFruitTopping: `${cakeFruitTopping!.value === "other" ? cakeFruitToppingInput! : cakeFruitTopping!.label}`,
            // CUPCAKE PARAMS
            ...
            cupcakeFruitFilling: `${cupcakeFruitFilling!.value === "other" ? cupcakeFruitFillingInput : cupcakeFruitFilling!.label}`,
            cupcakeFruitTopping: `${cupcakeFruitTopping!.value === "other" ? cupcakeFruitToppingInput : cupcakeFruitTopping!.label}`,
            // COOKIE PARAMS
            ...
            cookieFruitFilling: `${cookieFruitFilling!.value === "other" ? cookieFruitFillingInput : cookieFruitFilling!.label}`,
            cookieFruitTopping: `${cookieFruitTopping!.value === "other" ? cookieFruitToppingInput : cookieFruitTopping!.label}`,
        };
