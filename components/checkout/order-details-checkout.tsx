...
const OrderDetailsCheckout = () => {
    ...
    const DELIVERY_FEE_PERCENTAGE = 0.1;
    ...
    // Calculate delivery fee (only if delivery method is "delivery")
    const deliveryFee = deliveryMethod === "delivery" ? subtotal * DELIVERY_FEE_PERCENTAGE : 0;
