...
interface IContinueShoppingModalProps {
    isOpen: boolean;
    closeModal: () => void;
    confirmEstimate: () => void;
}

const ContinueShoppingModal = (props: IContinueShoppingModalProps) => {
    return (
                            ...
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-center align-middle shadow-xl transition-all">
                                ...
                                <div className="my-4">
                                    <p className="text-sm text-gray-500">
                                        Would you like to add more items to your estimate or complete your estimate request?
                                    </p>
                                </div>
