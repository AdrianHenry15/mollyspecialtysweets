  ...
  return (
    <motion.div
      ...
      <Link
        ...
        <h5 className="text-white my-4 font-semibold text-2xl transition-colors duration-500 hover:text-blue-400">
          {props.name}
        </h5>
        <p className="text-white font-light w-full transition-colors duration-500 hover:text-blue-400">
          {props.description}
        </p>
