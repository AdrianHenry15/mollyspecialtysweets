...
const CookieCupcakeProduct = (props: CookieCupcakeProductProps) => {
    ...
    return (
        <div className="flex flex-col">
            ...
            {/* Flavor */}
            <CustomSelect
                value={product.collection === "Cookies" ? "cookieFlavor" : "cupcakeFlavor"}
                title="Flavor"
            ...
            {/* Frosting */}
            <CustomSelect
                value={product.collection === "Cookies" ? "cookieFrosting" : "cupcakeFrosting"}
                title="Frosting"
            ...
            {/* Filling */}
            <CustomSelect
                value={product.collection === "Cookies" ? "cookieFilling" : "cupcakeFilling"}
                title="Filling"
            ...
            {/* Topping */}
            <CustomSelect
                value={product.collection === "Cookies" ? "cookieTopping" : "cupcakeTopping"}
                title="Topping"
